...
public class ComunidadHome {
	...
	private static final Log log = LogFactory.getLog(ComunidadHome.class);
	...
	public void attachDirty(Comunidad instance) {
		log.debug("attaching dirty Comunidad instance");
		try {
	...
	public void attachClean(Comunidad instance) {
		log.debug("attaching clean Comunidad instance");
		try {
	...
	public void delete(Comunidad persistentInstance) {
		log.debug("deleting Comunidad instance");
		try {
	...
	public List findByExample(Comunidad instance) {
		log.debug("finding Comunidad instance by example");
		try {
			List results = sessionFactory.getCurrentSession().createCriteria(
					"Comunidad").add(Example.create(instance)).list();
