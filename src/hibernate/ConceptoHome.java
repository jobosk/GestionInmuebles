...
public class ConceptoHome {
	...
	private static final Log log = LogFactory.getLog(ConceptoHome.class);
	...
	public void persist(Concepto transientInstance) {
		log.debug("persisting Concepto instance");
		try {
	...
	public void attachDirty(Concepto instance) {
		log.debug("attaching dirty Concepto instance");
		try {
	...
	public void attachClean(Concepto instance) {
		log.debug("attaching clean Concepto instance");
		try {
	...
	public void delete(Concepto persistentInstance) {
		log.debug("deleting Concepto instance");
		try {
	...
	public Concepto merge(Concepto detachedInstance) {
		log.debug("merging Concepto instance");
		try {
	...
	public Concepto findById(int id) {
		log.debug("getting Concepto instance with id: " + id);
		try {
	...
	public List findByExample(Concepto instance) {
		log.debug("finding Concepto instance by example");
		try {
			List results = sessionFactory.getCurrentSession().createCriteria(
					"Concepto").add(Example.create(instance)).list();
